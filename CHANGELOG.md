...
## [v0.1.14](https://github.com/Warashi/cage/compare/v0.1.13...v0.1.14) - 2026-09-22
...
- fix(goreleaser): drop deprecated verified param from cask url by @Warashi in https://github.com/Warashi/cage/pull/89
- build(deps): bump the github-actions-all group across 1 directory with 5 updates by @dependabot[bot] in https://github.com/Warashi/cage/pull/88
- build(deps): bump the github-actions-all group with 8 updates by @dependabot[bot] in https://github.com/Warashi/cage/pull/90
